...
| RC Ch. 2.1, Thm. 2.3 / Eq. 2.4-2.5 | local Holley criterion predicates and easy direction | `Percolation.FiniteCubeMeasure.LocalHolleyOneCondition`, `Percolation.FiniteCubeMeasure.LocalHolleyTwoCondition`, `Percolation.FiniteCubeMeasure.LocalHolleyCondition`, `Percolation.FiniteCubeMeasure.localHolleyCondition_of_holleyCondition`, `Percolation.FiniteCubeMeasure.localHolleyTwoCondition_self_iff_localTwoCoordinateFKG` | proved partial | defines the local one-edge and two-edge inequalities and proves global Holley implies them by forced-corner meet/join rewrites; the converse Hamming-distance induction remains future work |
