...
| RC Ch. 2.1, Thm. 2.6 / Eq. 2.7 and Eq. 2.14 | one-point conditional monotonicity and its cross-multiplied atom form | `Percolation.FiniteCubeMeasure.coordOpenEvent`, `Percolation.FiniteCubeMeasure.forceOpen`, `Percolation.FiniteCubeMeasure.forceClosed`, `Percolation.FiniteCubeMeasure.conditionDenom_singleton`, `Percolation.FiniteCubeMeasure.onePointOpenProb_eq_div`, `Percolation.FiniteCubeMeasure.onePointOpenProb_le_iff_cross`, `Percolation.FiniteCubeMeasure.onePointOpenProb_le_of_holleyCondition`, `Percolation.FiniteCubeMeasure.twoCoordinateCross_le_of_oneMonotonicMeasure` | proved partial | proves the easy direction by conditioning both measures on the one-coordinate cube, deriving Holley for the conditional pair, and applying stochastic domination to the coordinate-open event; also proves the singleton conditional probability formula, the equivalence with (2.14), and the two-coordinate local cross inequality produced by 1-monotonicity. The reverse implication remains future work via Theorem 2.3 |
