...
| Exploration histories | Deterministic accepted/rejected/frontier state machine and the infinite-output consequence of verified prefix inequalities. | `SiteExplorationState`, `SiteExploration`, `SiteExploration.step`, `SiteExploration.stateAfter`, `SiteExploration.step_wellFormed`, `SiteExploration.stateAfter_wellFormed`, `infinite_siteSet_probability_eq_one_of_prefixSequential`, `infinite_siteSet_probability_pos_of_prefixSequential` | proved slice | The fixed linear order is explicit. Identifying an exploration pushforward law and deriving its prefix inequalities from source history estimates remain open. |
...
| **Infrastructure subtotal** |  |  | **8302s** |  |  | **2,185,229** |
