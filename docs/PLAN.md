...
| RC3 | Ch. 2 | Stochastic ordering, positive association, influence, sharp thresholds | RandomCluster | partial: finite monotonic-measure Holley 2.1, FKG 2.16, the forward local-Holley implication of 2.3 plus comparable-pair/opposite-corner reverse-local scaffolding, complement duality, and the left-side distance-decreasing branch of the non-comparable Hamming induction, the one-point conditional criterion 2.6 reduced both ways up to the full Theorem 2.3 induction, Eq. 2.14 singleton-conditioning algebra, local two-coordinate FKG pair inequalities from 1-monotonicity, and the forward conditional/monotonicity implications of 2.24 proved in `RandomCluster/MonotonicMeasures`; full local converse induction, influence, and sharp thresholds remain target |
