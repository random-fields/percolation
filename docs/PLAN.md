...
| RC3 | Ch. 2 | Stochastic ordering, positive association, influence, sharp thresholds | RandomCluster | partial: finite monotonic-measure Holley 2.1, FKG 2.16, the forward local-Holley implication of 2.3 plus comparable-pair/opposite-corner reverse-local scaffolding, complement duality, and the left-side distance-decreasing branch of the non-comparable Hamming induction, the full one-point conditional criterion 2.6, Eq. 2.14 singleton-conditioning algebra, local two-coordinate FKG pair inequalities from 1-monotonicity, Theorem 2.24 proved through `(b) => (a)`, `(b) => (c)`, `(c) => (d)`, and `(d) => (b)`, plus Eq. 2.42 tilted finite-cube measures, Eq. 2.45 covariance decomposition, and Lemma 2.50 influence equality under transitive permutation-family symmetry in `RandomCluster/MonotonicMeasures`; strong-positive-association converse, Theorem 2.43 derivative formula, Theorem 2.28 influence bound, and sharp thresholds remain target |
