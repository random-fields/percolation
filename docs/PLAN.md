...
| P7 | Ch. 2.4 | Russo's formula and pivotal edges | Bernoulli | finite pivotal identities plus heterogeneous coordinate-difference and one-coordinate derivative identities proved; uniform derivative formula target |
