...
| P12 | Ch. 7 | Supercritical renormalization and slab criteria | Critical | **in progress**: induced-region/site percolation, finite-history exploration, source-facing Lemmas 7.9 and 7.17, and adaptive exploration Lemma 7.24 are proved; the concrete Grimmett--Marstrand history law for 7.2 and the half-space/static stacks remain; see `audit/topics/topic-07-dynamic-static-renormalization.md` |
