...
- **[done]** One-point conditional criterion in both directions for RC Ch. 2.6:
  `HolleyCondition ↔ OnePointConditionalDomination`.
- **[done]** The `(d) => (b)` implication of RC Ch. 2.24 and the strict-positive
  equivalences between FKG lattice condition, monotonicity, and 1-monotonicity.
